...
public class RingtoneManager {
    ...
    public static final int TYPE_NOTIFICATION_2 = 16;
    /**
     * All types of sounds.
     */
    ...
    private static String constructBooleanTrueWhereClause(List<String> columns) {
		...
		Log.d(TAG," constructBooleanTrueWhereClause columns.size():"+ columns.size()  + "  columns.get(i):"+ columns.get(i));
		try{
                 sb.append(columns.get(i)).append("=1 or ");
		    Log.d(TAG," constructBooleanTrueWhereClause sb:  " + sb.toString());
    ...
    private static String getCard2SettingForType(int type) {
	 Log.d(TAG, "getCard2SettingForType type = " + type);
	 if ((type & TYPE_RINGTONE_2) != 0){
		Log.d(TAG, "getSettingForType card 2 ringtone");
		return Settings.System.CARD2_RINGTONE;
	} else if ((type & TYPE_NOTIFICATION_2) != 0) {
		Log.d(TAG, "getSettingForType card 2 notification");
		return Settings.System.CARD2_NOTIFICATION_SOUND;
    ...
    public static Uri getCard2ActualDefaultRingtoneUri(Context context, int type) {
        String setting = getCard2SettingForType(type);
        if (setting == null) return null;
        final String uriString = Settings.System.getString(context.getContentResolver(), setting);
        Log.i(TAG, "Get card2 actual default ringtone uri= " + uriString);
        return uriString != null ? Uri.parse(uriString) : null;
    }

	public static void setCard2ActualDefaultRingtoneUri(Context context, int type, Uri ringtoneUri) {
		String setting = getCard2SettingForType(type);
		if (setting == null) {
			return;
    ...
    private static String getSettingForType(int type) {
        ...
        } else if ((type & (TYPE_NOTIFICATION | TYPE_NOTIFICATION_2)) != 0) {
    ...
    public static int getDefaultType(Uri defaultRingtoneUri) {
        if (defaultRingtoneUri == null) {
            ...
            return TYPE_ALARM;
        }else if(defaultRingtoneUri.equals(Settings.System.CARD2_DEFAULT_RINGTONE_URI)){
	     return TYPE_RINGTONE_2;
        }else if(defaultRingtoneUri.equals(Settings.System.CARD2_DEFAULT_NOTIFICATION_URI)) {
		return TYPE_NOTIFICATION_2;
	 } else {
            return -1;
        }
    }
