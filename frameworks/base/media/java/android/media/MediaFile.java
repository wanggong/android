...
public class MediaFile {
    ...
    private static final int LAST_VIDEO_FILE_TYPE2 = FILE_TYPE_RM;
    //More audio file types
    public static final int FILE_TYPE_RA     = 300;
    private static final int FIRST_AUDIO_FILE_TYPE2 = FILE_TYPE_RA;
    private static final int LAST_AUDIO_FILE_TYPE2 = FILE_TYPE_RA;
    ...
    private static final int LAST_IMAGE_FILE_TYPE = FILE_TYPE_ICO;
    ...
    static {
        ...
        addFileType("3GP", FILE_TYPE_M4A, "audio/3gpp",  MtpConstants.FORMAT_MPEG);
        addFileType("3GPP", FILE_TYPE_M4A, "audio/3gpp", MtpConstants.FORMAT_MPEG);
        addFileType("3G2", FILE_TYPE_M4A, "audio/3gpp2", MtpConstants.FORMAT_MPEG);
        addFileType("3GPP2", FILE_TYPE_M4A, "audio/3gpp2", MtpConstants.FORMAT_MPEG);
        ...
        addFileType("VOB", FILE_TYPE_MP4, "video/mpeg", MtpConstants.FORMAT_MPEG);//ghb
        addFileType("MP4", FILE_TYPE_MP4, "video/mp4", MtpConstants.FORMAT_MPEG);
        addFileType("MOV", FILE_TYPE_MP4, "video/qt", MtpConstants.FORMAT_MPEG);
        addFileType("QT", FILE_TYPE_MP4, "video/qt", MtpConstants.FORMAT_MPEG);
        ...
        addFileType("FLA", FILE_TYPE_FLV, "audio/flv");
        addFileType("APE", FILE_TYPE_APE, "audio/ape");
        //if (isWMVEnabled()) {
        addFileType("WMV", FILE_TYPE_WMV, "video/x-ms-wmv", MtpConstants.FORMAT_WMV);
        addFileType("ASF", FILE_TYPE_ASF, "video/x-ms-asf");
        addFileType("ASX", FILE_TYPE_ASF, "video/x-ms-wmv");
        //}
        ...
        addFileType("ICO", FILE_TYPE_ICO, "application/octet-stream");
        ...
        addFileType("APL", FILE_TYPE_APE, "audio/ape");
        addFileType("MAC", FILE_TYPE_APE, "audio/ape");
        addFileType("ZIP", FILE_TYPE_ZIP, "application/zip");
        addFileType("MPG", FILE_TYPE_MP2PS, "video/mp2p");
        addFileType("MPEG", FILE_TYPE_MP2PS, "video/mp2p");
        addFileType("RM", FILE_TYPE_RM, "video/rmff");
        addFileType("RMVB", FILE_TYPE_RM, "video/rmff");
        addFileType("RA", FILE_TYPE_RA, "audio/x-realaudio");
    }
