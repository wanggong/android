...
enum {
    ...
    /* buffer will be used with the HW video encoder */
    GRALLOC_USAGE_HW_VIDEO_DECODER      = 0x00080000,
    /* buffer will be used to reset camera buffer */
    GRALLOC_USAGE_HW_CAMERA_RESET       = 0x00100000,
    /* mask for the software usage bit-mask */
    GRALLOC_USAGE_HW_MASK               = 0x001F1F00,
