...
typedef enum {
    ...
    /* for lc platform */
    POWER_HINT_ACTIVITY = 0x00000006,
    POWER_HINT_CAMERA_DENOISE = 0x00000007,
    POWER_HINT_TOUCH = 0x00000008
} power_hint_t;

/**
 * Data structure for power hint interaction
*/
struct power_interaction_data {
    int cpu_nr;
    int duration;
};
typedef enum {
